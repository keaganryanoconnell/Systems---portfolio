      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
          ...
          <div className="flex items-center gap-3">
            <a href="https://github.com" target="_blank" className="p-2.5 rounded-md border border-border text-text-soft hover:text-text hover:border-border-hover transition-all" title="GitHub">
              <Github size={18} />
            </a>
            <a href="https://linkedin.com" target="_blank" className="p-2.5 rounded-md border border-border text-text-soft hover:text-text hover:border-text-soft transition-all" title="LinkedIn">
              <Linkedin size={18} />
            </a>
            <a href="mailto:hello@example.com" className="p-2.5 rounded-md border border-border text-text-soft hover:text-text hover:border-text-soft transition-all" title="Email">
              <Mail size={18} />
            </a>
          </div>
        </div>
