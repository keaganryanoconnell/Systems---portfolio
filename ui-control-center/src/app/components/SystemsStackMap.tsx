...
const NODES: CrateNode[] = [
  ...
  { id:"ingest", label:"Ingestion Server", tier:2, category:"Distributed", x:620,y:300, color:"#58a6ff", problem:"TCP read() copies eat 40% CPU at 10Gbps", primitives:"io_uring zero-copy, tokio, IngestBuffer", metric:"16MB max frame, port 8400" },
  { id:"syncsvr", label:"Sync Server", tier:3, category:"Capstone", x:200,y:420, color:"#8b5cf6", problem:"WebSocket head-of-line blocking at scale", primitives:"QUIC streams, CRDT merge, SessionManager", metric:"256 peers, port 9400, delta sync" },
];
...
const EDGES: [string, string][] = [
  ...
  ["protocol","raft"],["protocol","broker"],["render","columnar"],["ingest","broker"],["syncsvr","admin"],
];
