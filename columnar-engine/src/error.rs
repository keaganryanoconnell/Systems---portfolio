    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::InvalidOffset {
                ...
                f,
                "Invalid offset for {}: {} exceeds total {}",
                field, offset, total
            ),
            ...
            Self::BufferTooSmall { needed, capacity } => write!(
                f,
                "Output buffer too small: need {} slots, have {}",
                needed, capacity
            ),
            Self::MemoryLimitExceeded { current, max } => {
                write!(f, "Memory limit exceeded: {} / {} bytes", current, max)
            }
